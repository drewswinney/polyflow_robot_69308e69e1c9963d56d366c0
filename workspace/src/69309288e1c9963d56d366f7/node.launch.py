...
def generate_launch_description():
    parameters = json.loads('{"joint":"6930927fe1c9963d56d366ea","control_mode":"position","limit.lower_position":0,"limit.upper_position":360,"limit.position_step":1,"limit.max_effort":10,"limit.effort_step":null,"limit.max_velocity":35,"limit.velocity_step":0}')
    ...
    env = {
        "POLYFLOW_NODE_ID": "69309288e1c9963d56d366f7",
    ...
    return LaunchDescription(
        [
            ExecuteProcess(
                cmd=["python3", "workspace/src/69309288e1c9963d56d366f7/odrive-s1/node.py"],
                additional_env=env,
                output="screen",
            )
        ]
